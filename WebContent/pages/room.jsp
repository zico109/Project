		...
		<div class="container">
			...
			<div class="top-cart-block">
				<div class="top-cart-info">
					<a href="javascript:void(0);" class="top-cart-info-count"><%=cart.countroom()%></a>
				...
				<div class="top-cart-content-wrapper">
					...
					<div class="top-cart-content">
						<ul class="scroller" style="height: 250px;">
							<%
								for (Map.Entry<String, Room> list : cart.getCartRooms().entrySet()) {
							%>
							<li><a href="shop-item.html"><img
									src="<%=list.getValue().getPhong().getAnhSP()%>"

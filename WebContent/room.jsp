        ...
        <div class="row mb-5">
          <div class="col-md-12 mb-5">
			...
			for (LoaiPhong lp : list) {
				String maDoiTuong = lp.getMaLP();
				String tenDoiTuong = lp.getTenLP();
		...
		<div class="col-md-3 md-col">
			<div class="col-md">
				<a href="#"><img height="300px" width="150px"
					src='<%="kTXSm2/images/sanphams/" + lp.getAnh()%>'
					alt="<%=lp.getTenLP()%>" /></a>
				<div class="top-content">
					<h5>
						<a href="xemChiTiet<%=tenLop%>.action?maobj=<%=maDoiTuong%>"><%=lp.getTenLP()%></a>
					</h5>
					<div class="white">

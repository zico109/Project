...
<%@page import="core.model.GiuongDaDat"%>
...
<body class="ecommerce">
	...
	<div class="header">
		<div class="container">
			<a class="site-logo" href="trangchu.jsp">Smart Hostel</a> <a
			...
			<div class="top-cart-block">
				<div class="top-cart-info">
					<a href="javascript:void(0);" class="top-cart-info-count"><%=cart.countbed()%></a>
				...
				<div class="top-cart-content-wrapper">
					<div class="top-cart-content">
						<ul class="scroller" style="height: 250px;">
							<%
								for (Map.Entry<String, GiuongDaDat> list : cart.getCartBeds().entrySet()) {
							%>
							<li><a href="shop-item.html"><img
									src="<%=list.getValue().getGiuong().getMaGiuong()%>"
									alt="Rolex Classic Watch" width="37" height="34"></a> <span
								class="cart-content-count">x <%=list.getValue().getSoLuong()%></span>
								<strong><a href="shop-item.html"><%=list.getValue().getGiuong().getTrangThai()%></a></strong></li>
							<%
								}
							%>
						</ul>
								...
								<table summary="Shopping cart">
									...
									<tr>
										...
										<td class="goods-page-description">
											<h3>
												<a href="chiteitsanpham.jsp"><%=list.getValue().getGiuong().getTrangThai()%></a>
											</h3>											
										</td>

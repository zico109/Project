...
public class Controller_TrangThaiPhong extends TrangThaiPhong implements ZEController{
	ObjectDAO dao = new DAO_TrangThaiPhong();
	...
	public String viewDetail() {
		...
		ArrayList<TrangThaiPhong> arr = dao.listByColumnLike(tenCotTimDoiTuong, maobj);
		if (arr.size() > 0) {
	...
	public String saveOrUpdate() {
		...
		TrangThaiPhong obj = new TrangThaiPhong();
		obj.maTrangThaiPhong = getMaTrangThaiPhong();
		obj.tenTrangThaiPhong = getTenTrangThaiPhong();
		obj.soLuongKhach = getSoLuongKhach();
		obj.phong = getPhong();
	...
	public String search() {
		...
		ArrayList<TrangThaiPhong> arr = dao.listByColumnLike(column, key);
